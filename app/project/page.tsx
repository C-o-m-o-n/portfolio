    ...
    return (
        <main className="min-h-screen p-4 md:p-12 lg:p-24">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
                ...
                <div>
               <h2 className="text-2xl mb-8 font-mono">send me your budget and a description of your project.</h2>     
                    ...
                    <div className="p-3 m-2">
                        <p className="flex gap-2 items-center p-2"><span><MdOutlineMessage /></span>Enter your project description</p>
